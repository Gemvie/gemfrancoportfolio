        ...
        <FadeIn>
          ...
          <div className="mt-10 flex flex-col items-center gap-3">
            <a
              ...
              className="w-full max-w-sm inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-full bg-accent-bright text-background font-semibold hover:glow-accent transition-shadow"
            >
